...
1. Download [Prebuilt Binary](https://github.com/projetoeureka/oauth2_proxy/releases) (current release is `v2.0.1`) or build with `$ go get github.com/projetoeureka/oauth2_proxy` which will put the binary in `$GOROOT/bin`
